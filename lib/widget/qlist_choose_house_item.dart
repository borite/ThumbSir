...
class QlistChooseHouseItem extends StatefulWidget {
  final houseItem;
  QlistChooseHouseItem({Key? key,
    this.houseItem,
  }):super(key:key);
  @override
  _QlistChooseHouseItemState createState() => _QlistChooseHouseItemState();
}

class _QlistChooseHouseItemState extends State<QlistChooseHouseItem> with SingleTickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        dynamic houseMsg =widget.houseItem.houseCommunity
            +"+"+widget.houseItem.houseAddress
            +"+"+widget.houseItem.houseId.toString();
        Navigator.of(context).pop(houseMsg);
      },
      child: Container(
        width: 335,
