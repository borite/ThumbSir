...
class TeamDayAnalyze extends StatefulWidget {
  @override
  _TeamDayAnalyzeState createState() => _TeamDayAnalyzeState();
}

class _TeamDayAnalyzeState extends State<TeamDayAnalyze> {
