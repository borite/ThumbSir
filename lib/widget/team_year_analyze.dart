...
class TeamYearAnalyze extends StatefulWidget {
  @override
  _TeamYearAnalyzeState createState() => _TeamYearAnalyzeState();
}

class _TeamYearAnalyzeState extends State<TeamYearAnalyze> {
  ...
  _onYearPicker(context) {
    Alert(
      context: context,
      title: "",
      content: Column(
        children: <Widget>[
          Text("选择年份",style:TextStyle(
            fontSize: 20,
            color: Color(0xFF0E7AE6),
