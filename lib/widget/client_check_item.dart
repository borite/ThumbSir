...
class ClientCheckItem extends StatefulWidget {
  final String name;
  final int star;
  final int gender;
  final int age;
  ...
  ClientCheckItem({Key key,
    this.name,this.star,this.gender,this.age,this.phone,this.birthday,
    this.need,this.action, this.item,this.giftList,
  }):super(key:key);
  @override
  _ClientCheckItemState createState() => _ClientCheckItemState();
}

class _ClientCheckItemState extends State<ClientCheckItem> with SingleTickerProviderStateMixin{
  bool _extend = false;
