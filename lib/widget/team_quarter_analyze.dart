...
class TeamQuarterAnalyze extends StatefulWidget {
  @override
  _TeamQuarterAnalyzeState createState() => _TeamQuarterAnalyzeState();
}

class _TeamQuarterAnalyzeState extends State<TeamQuarterAnalyze> {
