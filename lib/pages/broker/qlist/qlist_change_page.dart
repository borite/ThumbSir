                      ...
                      onTap: ()async {
                        ...
                        if (chooseId!="13" && dateTimeEndTime.difference(dateTimeStartTime).inMinutes <= 0) {
                          ...
                          if (chooseId == "15" || chooseId == "16") {
                            ...
                            }else if(result1516.code == 402){
                              setState(() {
                                searchResult = result1516;
                              });
                              // _onTimeAlertPressed(context);
                              _onTimeAlert402Pressed(context);
                            }else if(result1516.code == 401){
                              setState(() {
                                searchResult = result1516;
                              });
                          ...
                          if (chooseId == "13") {
                            ...
                            }else if(result13.code == 402){
                              setState(() {
                                searchResult = result13;
                              });
                              // _onTimeAlertPressed(context);
                              _onTimeAlert402Pressed(context);
                            }else if(result13.code == 401){
                              setState(() {
                                searchResult = result13;
                              });
                              _onTimeAlert401Pressed(context);
                          ...
                          if (chooseId == "12" && isRemark == true &&
                            ...
                            }else if(result12.code == 402){
                              setState(() {
                                searchResult = result12;
                              });
                              // _onTimeAlertPressed(context);
                              _onTimeAlert402Pressed(context);
                            }else if(result12.code == 401){
                              setState(() {
                                searchResult = result12;
                              });
                              _onTimeAlert401Pressed(context);
        ...
        child: Column(
          children: [
            Text(
              ...
              "各任务的计划时间不可重复，如果修改，将自动删除以下任务（列表可滚动）：" :"",
              style: TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.normal
              ),
            ...
            Text(
              ...
              "并自动将以下任务做如下调整（列表可滚动）："
              :searchResult.data != null && searchResult.data.delPlans.length == 0 && searchResult.data.modiPlans.length != 0?
              "各任务的计划时间不可重复，如果修改，会自动将以下任务做如下调整（列表可滚动）："
                  :"",
              style: TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.normal
