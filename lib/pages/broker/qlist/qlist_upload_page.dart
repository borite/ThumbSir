...
//     required this.uploadImgs,
//     required this.name,required this.star,required this.defaultId,required this.planCount,
//     required this.percent,required this.currentAddress,required this.taskId,required this.unit,
