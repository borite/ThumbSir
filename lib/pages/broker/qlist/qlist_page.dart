          ...
          ListView(
            children: <Widget>[
              Container(
                decoration: BoxDecoration(color: Colors.white),
                child: Padding(
                  padding: EdgeInsets.only(top:270,bottom:100),
                  child:Column(
                    children: <Widget>[
                      // 每一条量化
                              ...
                              Row(
                                children: <Widget>[
                                  ...
                                  Container(
                                    ...
                                    child: Text('晚上',style: TextStyle(fontSize: 14,color: Color(0xFF93C0FB),decoration: TextDecoration.none,fontWeight: FontWeight.normal,),),
                                  )
                                ],
                              ),
                            ],
