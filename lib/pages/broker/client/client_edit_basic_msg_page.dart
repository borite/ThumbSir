...
class ClientEditBasicMsgPage extends StatefulWidget {
  final item;

  ClientEditBasicMsgPage({Key key,
    this.item
  }):super(key:key);
  @override
  _ClientEditBasicMsgPageState createState() => _ClientEditBasicMsgPageState();
}

class _ClientEditBasicMsgPageState extends State<ClientEditBasicMsgPage> {
  bool _loading = false;
