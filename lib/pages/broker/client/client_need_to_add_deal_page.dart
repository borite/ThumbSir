...
class ClientNeedToAddDealPage extends StatefulWidget {
  final item;
  final needID;
  final needItem;
  ...
  @override
  _ClientNeedToAddDealPageState createState() => _ClientNeedToAddDealPageState();
}

class _ClientNeedToAddDealPageState extends State<ClientNeedToAddDealPage> {
  bool _loading = false;
  ...
  void initState() {
    ...
    remarkReg = TextReg;
    _getUserInfo();
    dealMinCount = widget.needItem.mainNeed;
    super.initState();
  }
                          ...
                          GestureDetector(
                            onTap: ()async{
                              ...
                              if(addResult.code == 200){
                                var deleteNeed = await DeleteCustomerNeedDao.deleteCustomerNeed(widget.needID.toString());
