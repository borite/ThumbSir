...
class AddLeaderPage extends StatefulWidget {
  @override
  _AddLeaderPageState createState() => _AddLeaderPageState();
}

class _AddLeaderPageState extends State<AddLeaderPage> {
  @override
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Row(
                              children: <Widget>[
                                Text('您还可以向上级发送职位邀请，马上去分享链接',style: TextStyle(
                                  fontSize: 14,
                                  color: Color(0xFF5580EB),
                                  fontWeight: FontWeight.normal,
                                  decoration: TextDecoration.none,
