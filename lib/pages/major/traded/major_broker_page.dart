...
class MajorBrokerPage extends StatefulWidget {
  @override
  _MajorBrokerPageState createState() => _MajorBrokerPageState();
}

class _MajorBrokerPageState extends State<MajorBrokerPage> {
  int _currentIndex = 0;
  @override
