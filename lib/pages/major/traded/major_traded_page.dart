...
class MajorTradedPage extends StatefulWidget {
  @override
  _MajorTradedPageState createState() => _MajorTradedPageState();
}

class _MajorTradedPageState extends State<MajorTradedPage> {
  int _currentIndex = 0;
  @override
