...
class HouseAddOwnerMsgPage extends StatefulWidget {
  final houseId;
  HouseAddOwnerMsgPage({Key key,
    this.houseId
  }):super(key:key);
  @override
  _HouseAddOwnerMsgPageState createState() => _HouseAddOwnerMsgPageState();
}

class _HouseAddOwnerMsgPageState extends State<HouseAddOwnerMsgPage> {
  bool _loading = false;
