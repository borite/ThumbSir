import 'dart:convert';
import 'dart:io';
import 'package:ThumbSir/dao/add_house_step4_dao.dart';
import 'package:ThumbSir/dao/change_exclusive_user_dao.dart';
...
class HouseUploadOnlyEntrustPage extends StatefulWidget {
  final houseId;
  final houseDetail;
  HouseUploadOnlyEntrustPage({Key key,
    this.houseId,this.houseDetail
  }):super(key:key);
  @override
  _HouseUploadOnlyEntrustPageState createState() => _HouseUploadOnlyEntrustPageState();
}

class _HouseUploadOnlyEntrustPageState extends State<HouseUploadOnlyEntrustPage> {
  bool _loading = false;
                                  ...
                                  Row(
                                    children: <Widget>[
                                      ...
                                      Padding(
                                        ...
                                        child: Text('上传独家协议照片',style: TextStyle(
                                          fontSize: 16,
                          ...
                          GestureDetector(
                            onTap: ()async{
                              ...
                              var addImgsResult = await AddHouseStep4Dao.addHouseStep4(
                                ...
                                widget.houseDetail.housePrivateInformation[0].consignmentAgreement??"",
                                widget.houseDetail.housePrivateInformation[0].consignmentAgreementStart??"",
                                widget.houseDetail.housePrivateInformation[0].consignmentAgreementExxpr??"",
                                dealImgs,
                              ...
                              if (addImgsResult.code == 200 || addImgsResult.code == 201) {
                                var updateUserResult = await ChangeExclusiveUserDao.changeExclusiveUser(
                                  widget.houseId.toString(),
                                  userData.userPid,
                                );
