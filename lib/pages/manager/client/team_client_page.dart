              ...
              GestureDetector(
                onTap: (){
                  if(currentLevelResult == '4'){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>GroupClientDetailPage(
                        leaderArea : item.teamName,
                        leaderAreaRate : item.levelData1.keHuCount+item.levelData1.yeZhuCount,
                        leaderName : item.nextLeader.userName,
                        leaderID : item.nextLeader.userPid
                    )));
                  }else{
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>TeamClientDetailPage(
                        leaderArea : item.teamName,
                        leaderAreaRate : item.levelData1.keHuCount+item.levelData1.yeZhuCount,
                        leaderName : item.nextLeader.userName,
                        leaderID : item.nextLeader.userPid
                            ...
                            child: Column(
                              children: <Widget>[
                                ...
                                Container(
                                  width: 200,
                                  child: Text(
                                    '购买/租赁需求数：'+item.levelData1.keHuCount.toString(),
                                    style:TextStyle(
                                      fontSize: 12,
                                ...
                                Container(
                                  width: 200,
                                  child: Text(
                                    '出售/出租需求数：'+item.levelData1.yeZhuCount.toString(),
                                    style:TextStyle(
                                      fontSize: 12,
                                      color: Color(0xFF999999),
                                      fontWeight: FontWeight.normal,
                                ...
                                Container(
                                  width: 200,
                                  child: Text(
                                    '有多个需求的客户数：'+item.levelData1.duoXuQiuCount.toString(),
                                    style:TextStyle(
                                      fontSize: 12,
                                      color: Color(0xFF999999),
                                      fontWeight: FontWeight.normal,
