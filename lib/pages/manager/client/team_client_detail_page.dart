...
class TeamClientDetailPage extends StatefulWidget {
  ...
  TeamClientDetailPage({this.leaderArea,this.leaderName,this.leaderID,this.leaderAreaRate});
  @override
  _TeamClientDetailPageState createState() => _TeamClientDetailPageState();
}
