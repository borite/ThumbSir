...
class GroupTradedDetailPage extends StatefulWidget {
  final leaderArea;
  final leaderName;
  final leaderID;
  final leaderAreaRate;
  GroupTradedDetailPage({this.leaderArea,this.leaderName,this.leaderID,this.leaderAreaRate});
  @override
  _GroupTradedDetailPageState createState() => _GroupTradedDetailPageState();
}

class _GroupTradedDetailPageState extends State<GroupTradedDetailPage> {
  bool _loading = false;
  var leaderResult;
  var listResult;
  var leaderInfo;
                                      ...
                                      child: Column(
                                        children: <Widget>[
                                          ...
                                          Container(
                                            ...
                                            child: Text(
                                              leaderCount!=null?
                                              '拥有客户数：'+leaderCount.planningCount.toString()
                                              :'拥有客户数：0',
                                              style:TextStyle(
                                                fontSize: 12,
                                                color: Color(0xFF999999),
