...
import 'package:ThumbSir/pages/manager/qlist/group_analyze_page.dart';
import 'package:ThumbSir/pages/manager/qlist/group_list_page.dart';
...
class ManagerQListPage extends StatefulWidget {
  @override
  _ManagerQListPageState createState() => _ManagerQListPageState();
}

class _ManagerQListPageState extends State<ManagerQListPage> with SingleTickerProviderStateMixin{
  int _currentIndex = 0;
