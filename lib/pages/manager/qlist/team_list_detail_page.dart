...
class TeamListDetailPage extends StatefulWidget {
  ...
  TeamListDetailPage({this.leaderArea,this.leaderName,this.leaderID,this.leaderAreaRate});
  @override
                                      ...
                                      children: <Widget>[
                                        ...
                                        Container(
                                          ...
                                          child: Text(
                                            ...
                                            leaderCount != null?'今日计划：'+leaderCount.planningCount.toString()+'，已完成：'+leaderCount.finishCount.toString()
                                                :'今日无计划':'',
                                            style:TextStyle(
                                              fontSize: 12,
                                              color: Color(0xFF999999),
