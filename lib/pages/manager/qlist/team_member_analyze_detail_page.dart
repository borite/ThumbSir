...
class TeamMemberAnalyzeDetailPage extends StatefulWidget {
  final name;
  final id;
  TeamMemberAnalyzeDetailPage({this.name,this.id});
  @override
  _TeamMemberAnalyzeDetailPageState createState() => _TeamMemberAnalyzeDetailPageState();
}
