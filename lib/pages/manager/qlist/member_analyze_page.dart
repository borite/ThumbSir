...
class MemberAnalyzePage extends StatefulWidget {
  @override
  _MemberAnalyzePageState createState() => _MemberAnalyzePageState();
}

class _MemberAnalyzePageState extends State<MemberAnalyzePage> {
  @override
