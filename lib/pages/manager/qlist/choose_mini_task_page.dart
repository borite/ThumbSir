...
import 'package:ThumbSir/pages/manager/qlist/choose_mini_task_number_page.dart';
                        ...
                        Container(
                          ...
                          child: ChipsChoice<String>.multiple(
                            ...
                            choiceActiveStyle: const C2ChoiceStyle(
                              ...
                              backgroundColor: Color(0xFF6E85D3),
                              borderOpacity: .3,
                            ),
                            wrapped: true,
                          ),
                  ...
                  GestureDetector(
                    onTap: ()async{
                      if(userData != null && itemLength>1 && itemLength<=8){
                        dynamic creatMissionResult = await CreatMissionDao.creatMission(
                            userData!.companyId,
                            userData!.userPid,
                            selectTaskIDs,
                            minCount,
