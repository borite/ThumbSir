...
class Datum {
  ...
  String agentPhone;
  String houseArea;
  bool confirmFieldUser;
  bool confirmKeyUser;
  bool confirmDealUser;
  bool confirmExclusiveUser;
...
class HouseAroundInfo {
  ...
  Map<String, dynamic> toJson() => {
  "AroundInfoID": aroundInfoId == null ? null : aroundInfoId,
  "HouseID": houseId == null ? null : houseId,
...
class HouseBasicInfo {
  ...
  Map<String, dynamic> toJson() => {
    "BasicInfoID": basicInfoId == null ? null : basicInfoId,
    "HouseID": houseId == null ? null : houseId,
...
class HousePrivateInformation {
  ...
  Map<String, dynamic> toJson() => {
    "PrivateInfoID": privateInfoId == null ? null : privateInfoId,
    "HouseID": houseId == null ? null : houseId,
