...
class UpdateHouseUrgentlevelDao{
    static Future<CommonResult> updateHouseUrgentlevel(
        String HouseID,
        String LevelText,
    ) async {
      //组织要发送给APi的键值对
      var _body={
       ...
       final String apiUrl=api_perfix+"/api/houseresource/UpdateHouseUrgentlevel";
