...
class UpdateFieldImagesDao{
    static Future<CommonResult> updateFieldImages(
        String HouseID,
        String UserID,
        String HouseImages,
        String HouseVideos,
      ...
      var _body={
        ...
        "HousePlanImg":HousePlanImg,
      };
       final String apiUrl=api_perfix+"/api/houseresource/UpdateFieldImages";
